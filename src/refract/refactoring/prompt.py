...
def build_system_prompt(language: str) -> str:
    return (
        ...
        "For a magic-number fix, put your chosen UPPER_SNAKE_CASE name in the "
        "`constant_name` field and leave the placement to Refract: it will add the "
        "definition at module scope and rewrite the literal for you, so you do not "
        "have to reproduce the surrounding line. Still fill in `edits` as a fallback. "
